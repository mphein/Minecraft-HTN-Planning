...
def op_craft_wooden_planks (state, ID):
...
pyhop.declare_operators (op_punch_for_wood, op_craft_wooden_axe_at_bench, op_wooden_axe_for_wood, op_craft_wooden_planks, op_craft_bench, op_craft_sticks)
...
def craft_plank (state, ID):
	return [('have_enough', ID, 'wood', 1), ('op_craft_wooden_planks', ID)]
